...
const AboutDiva = () => {
  const divaLore = [
    ...
    },
    {
      ...
      icon: <Diamond className="w-6 h-6 text-pink-400" />,
    ...
    },
    {
      ...
      icon: <HandHeart className="w-6 h-6 text-rose-400" />,
    ...
    },
    {
      ...
      icon: <PartyPopper className="w-6 h-6 text-fuchsia-400" />,
  ...
  return (
    <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10 relative">
      {/* Background Glow */}
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-white/80 blur-[120px] rounded-full pointer-events-none -z-10"></div>
      ...
      <div className="text-center mb-16 animate-scale-up">
        <div className="inline-flex items-center gap-2 px-5 py-2 bg-white/80 border border-pink-200 rounded-full text-pink-600 text-sm font-bold uppercase tracking-widest mb-6 shadow-sm backdrop-blur-xl">
          <Crown className="w-4 h-4 text-pink-500" /> Founder & Server Queen
        </div>
        <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-rose-400 to-fuchsia-500 drop-shadow-sm">
          MEET DIVAAA
        </h1>
        <p className="text-xl text-pink-800/80 max-w-2xl mx-auto font-medium leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-tr from-pink-400 to-rose-400 rounded-3xl blur-2xl opacity-40 group-hover:opacity-60 transition-opacity duration-500"></div>
          <div className="relative bg-white/60 backdrop-blur-xl border border-pink-200 rounded-3xl p-4 shadow-[0_10px_30px_rgba(244,114,182,0.2)]">
            <video
              ...
              muted
              playsInline
              className="w-full aspect-[3/5] object-cover rounded-2xl border border-pink-100 shadow-inner"
            >
              Your browser does not support the video tag.
            </video>
            {/* Floating Badge */}
            <div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-pink-400 to-rose-400 p-4 rounded-2xl shadow-xl transform rotate-3 hover:rotate-0 transition-transform border border-white/50">
        ...
        <div className="space-y-8">
          <div className="bg-white/70 backdrop-blur-xl p-8 rounded-3xl border border-pink-100 hover:border-pink-300 hover:bg-white transition-all duration-300 shadow-[0_5px_20px_rgba(244,114,182,0.15)]">
            <h2 className="text-2xl font-black text-pink-950 mb-4 flex items-center gap-3 uppercase tracking-wide">
              <Heart className="w-6 h-6 text-pink-500" /> Her Vision
            </h2>
            <div className="space-y-4">
              <p className="text-pink-800/80 text-lg leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/60 backdrop-blur-xl p-6 rounded-3xl border border-pink-100 text-center hover:border-pink-300 hover:bg-white transition-all shadow-sm">
              <Star className="w-8 h-8 text-rose-400 mx-auto mb-3" />
              <div className="text-3xl font-black text-pink-950 mb-1">2016</div>
              <div className="text-xs font-bold text-pink-600 uppercase tracking-widest">
                Year Started
              </div>
            </div>
            <div className="bg-white/60 backdrop-blur-xl p-6 rounded-3xl border border-pink-100 text-center hover:border-pink-300 hover:bg-white transition-all shadow-sm">
              <Crown className="w-8 h-8 text-fuchsia-400 mx-auto mb-3" />
              <div className="text-3xl font-black text-pink-950 mb-1">
                Queen
              </div>
              <div className="text-xs font-bold text-pink-600 uppercase tracking-widest">
                Server Status
      ...
      <div className="relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-black text-pink-950 uppercase tracking-wide mb-4">
            The Lore of{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {divaLore.map((item, index) => (
            <div
              key={index}
              className="bg-white/70 backdrop-blur-xl p-8 rounded-3xl border border-pink-100 hover:border-pink-300 hover:bg-white transition-all duration-300 hover:-translate-y-2 shadow-[0_5px_15px_rgba(244,114,182,0.1)] hover:shadow-[0_15px_30px_rgba(244,114,182,0.2)] group"
            >
              <div className="bg-pink-50 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 border border-pink-100 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-300 shadow-inner">
                {item.icon}
              </div>
              <h3 className="text-xl font-black text-pink-950 mb-3 tracking-wide group-hover:text-pink-600 transition-colors">
                {item.title}
              </h3>
